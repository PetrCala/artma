...
Results are saved to your output directory, and in interactive sessions the folder
opens automatically. To skip auto-opening, use `open_results = FALSE`, and open later
with `artma::results.open()`.
