...
**Options are loaded only for the duration of the function call**. This prevents different analyses from interfering with each other. Each time you call `artma::run()`, the options file is freshly loaded.
